...
try
{
  let content=fs.readFileSync(`${__dirname}/pers.json`);
  globalStorage=JSON.parse(content.toString("utf8"));
}
catch (e)
{
  globalStorage={};
...
setInterval(()=>
{
  fs.writeFile(`${__dirname}/pers.json`, JSON.stringify(globalStorage));
}, 1000);
